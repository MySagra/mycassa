...
if 'API_BASE_URL' not in os.environ:
    print("⚠️  API_BASE_URL non impostata, uso valore di default: http://localhost:4300")
    os.environ['API_BASE_URL'] = 'http://localhost:4300'

if 'SECRET_KEY' not in os.environ:
    print("⚠️  SECRET_KEY non impostata, uso valore di default (NON SICURO PER PRODUZIONE!)")
